...
ifname_bytes  = fcntl.ioctl(tu n, TUNSETIFF, ifr)
...
sniff and print out icmp echo request packet
    if ICMP in pkt and pkt[ICMP].type == 8:
        ...
        arbdata = b'Instead of writing an IP packet to the interface, write some arbitrary data to the interface, and report your observation'
your observation.
